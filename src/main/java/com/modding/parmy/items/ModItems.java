...
public class ModItems {
    ...
    public static final RegistryObject<Item> DRONE_SPAWN_EGG = ITEMS.register(
        "drone_spawn_egg",
        () -> new ForgeSpawnEggItem(
            ModEntityTypes.DRONE,
            0x22b341,
            0x19732e,
    ...
    public static final RegistryObject<Item> DRONE_ITEM = ITEMS.register(
        "drone_item",
        () -> new DroneItem()
    );
